...
////  pmtest
////
////  Created by Richard Gasztany on 2022. 11. 09..
////
//
...
//            if (firstChar == "(") {
//                return method.substringWithRange(Range<String.Index>(start: method.startIndex.repeatedValue.advanced(by: 1), end: method.endIndex.advancedBy(0)))            }
//        }
//        return method
//    }
//
